...
kubectl set image deployment udagram-frontend udagram-frontend=dukeent/udagram-frontend:v10
kubectl set image deployment backend-feed backend-feed=dukeent/udagram-api-feed:v10
kubectl set image deployment backend-user backend-user=dukeent/udagram-api-user:v10
kubectl set image deployment reverseproxy reverseproxy=dukeent/udagram-reverseproxy:v10
