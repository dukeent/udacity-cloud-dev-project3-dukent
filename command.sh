...
kubectl set image deployment udagram-frontend udagram-frontend=dukeent/udagram-frontend:v11
kubectl set image deployment backend-feed backend-feed=dukeent/udagram-api-feed:v11
kubectl set image deployment backend-user backend-user=dukeent/udagram-api-user:v11
kubectl set image deployment reverseproxy reverseproxy=dukeent/udagram-reverseproxy:v11
